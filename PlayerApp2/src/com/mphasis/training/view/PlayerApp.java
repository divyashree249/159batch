...
public class PlayerApp {
	...
	List<Player> players1=playerDao.getPlayerByGender(sc.next());
	players1.forEach((p1)->System.out.println(p1));
	break;
	case 4:System.out.println("enter the contact");
	Player player2=playerDao.getPlayerByContact(sc.nextLong());
	System.out.println(player2);
	break;
	case 5:System.out.println("enter the TeamName");
	List<Player> players3=playerDao.getPlayerByTeamname(sc.next());
	players3.forEach((p1)->System.out.println(p1));
	break;
	case 6:System.out.println("enter the age");
	List<Player> players4=playerDao.getPlayerByAge(sc.nextInt());
	...
	List<Player> players5=playerDao.getPlayerByDob(d);
	players5.forEach((p1)->System.out.println(p1));
	break;
	case 8:System.out.println("enter the score");
	List<Player> players6=playerDao.getPlayerByAge(sc.nextInt());
